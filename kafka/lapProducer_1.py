...
@author: hemanth
@info: Generates lap data to kafka topic (car.id=1)
"""
import sys
            ...
            while True:
                    ...
                    with open('lap.txt') as file:
                        ...
                        for i in reader:
                            ...
                            msg = dumps(self.create_msg('1', i['m_lastLapTime'], i['m_currentLapTime'], i['m_bestLapTime'], i['m_lapDistance'], i['m_totalDistance'], i['m_currentLapNum']))
